...
export const passwordChangeService = new APIAuthService<UserResponse, ChangePassword>("/auth/change-password");
export const profileUpdateService = new APIAuthService<UserResponse, EditProfile>("/auth/edit-profile");
